...
> Registro histórico preservado da v0.2.1. Não use este arquivo como contrato vigente: na v0.3.1, `estadoCivil` e `tipoDocumento` são radios, START substitui qualquer semântica antiga de T0 e os novos campos estão documentados em `docs/seletores.md`.
